...
app.get('/rtmp-viewer', (req,res) => {
  res.sendFile('rtmp-viewer/index.html', { root: __dirname });
});

app.get('/hlsStreamsList', (req, res) => {
  res.json(hlsStreamsList)
})
